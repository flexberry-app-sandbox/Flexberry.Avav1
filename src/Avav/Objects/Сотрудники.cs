...
namespace IIS.Avav
{
    ...
    [View("СотрудникиL", new string[] {
            ...
            "Фио as \'Фио\'",
            "Телефон as \'Телефон\'"})]
    public class Сотрудники : IIS.Avav.Согласие
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Avav.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Avav.Сотрудники));
                }
            }
        }
    }
